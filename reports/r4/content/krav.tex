...
\begin{enumerate}
	...
	\begin{enumerate}
		\item \textcolor{red}{Billedtagning og -behandling}
		\begin{enumerate}
%			\item Hent billeder fra USB webcam
%			\item Behandl billeder og identificér bane, robot, 'kage' og forhindringer
			\item \textcolor{red}{Bestem position og retning for robot}
			\item \textcolor{red}{Bestem positioner for kager}
			\item \textcolor{red}{Bestem positioner for forhindringer}
		\end{enumerate}
