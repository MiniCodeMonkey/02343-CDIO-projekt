...
public class BasicControlGui extends javax.swing.JFrame {
	...
	public BasicControlGui(Connector c) throws UnsupportedLookAndFeelException,
    ...
    private void initComponents() {
        ...
        fwrBtn.setText("/\\");
            ...
            movePanelLayout.setHorizontalGroup(
                ...
                .addGroup(movePanelLayout.createSequentialGroup()
                    ...
                    .addGroup(movePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(stopBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 313, Short.MAX_VALUE)
                        .addGroup(movePanelLayout.createSequentialGroup()
                            ...
                            .addGroup(movePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(BckwBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 66, Short.MAX_VALUE)
                                .addComponent(fwrBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 66, Short.MAX_VALUE))
                            .addGroup(movePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(movePanelLayout.createSequentialGroup()
                                    .addGap(9, 9, 9)
            ...
            sensorPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Sensors"));
            ...
            layout.setHorizontalGroup(
                ...
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addComponent(jSeparator1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 431, Short.MAX_VALUE)
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(statusLabel)
                                    .addGap(18, 18, 18)
                                    .addComponent(statusPtyLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 142, Short.MAX_VALUE))
	...
	public void openClaw() {
		try {
			controller.open(clawspeedSlider.getValue());
		} catch (IOException e) {
			JOptionPane.showMessageDialog(this, e.getMessage(), "Fejl",
					JOptionPane.ERROR_MESSAGE);
			reset();
	...
	public void closeClaw() {
		try {
			controller.close(clawspeedSlider.getValue());
		} catch (IOException e) {
			JOptionPane.showMessageDialog(this, e.getMessage(), "Fejl",
					JOptionPane.ERROR_MESSAGE);
			reset();
