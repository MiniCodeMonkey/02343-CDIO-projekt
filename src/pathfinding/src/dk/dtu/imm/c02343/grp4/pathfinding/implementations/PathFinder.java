...
public class PathFinder {
	 ...
	 */
	public PathFinder(TileMap map, int maxSearchDistance, boolean allowDiagMovement) {
	 ...
	 * @param allowDiagMovement True if the search should try diaganol movement
	 */
	public PathFinder(TileMap map, int maxSearchDistance, 
	...
	/**
	 * Check if a given location is valid for the supplied robot
	 * 
	 * @param robot The robot that would hold a given location
	 ...
	 * 
	 * @param robot The entity that is being moved
